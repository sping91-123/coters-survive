...
expectIncludes(envExample, "TRADING_ECONOMICS_API_KEY=", "매크로 자동 캘린더 키 예시", ".env.example");
expectIncludes(envExample, "TRADING_ECONOMICS_CLIENT=", "매크로 자동 캘린더 client 예시", ".env.example");
expectIncludes(envExample, "TRADING_ECONOMICS_SECRET=", "매크로 자동 캘린더 secret 예시", ".env.example");
...
expectIncludes(macroCalendar, "TRADING_ECONOMICS_API_KEY", "매크로 Trading Economics 자동 연결", "src/lib/macroCalendar.ts");
expectIncludes(macroCalendar, "fetchTradingEconomicsCalendar", "매크로 자동 캘린더 fetch", "src/lib/macroCalendar.ts");
expectIncludes(macroCalendar, "getFallbackPayload", "매크로 백업 일정 fallback", "src/lib/macroCalendar.ts");
expectIncludes(macroCalendar, "Actual", "매크로 실제값 파싱", "src/lib/macroCalendar.ts");
expectIncludes(macroCalendar, "Forecast", "매크로 예상치 파싱", "src/lib/macroCalendar.ts");
expectIncludes(macroCalendar, "Previous", "매크로 이전값 파싱", "src/lib/macroCalendar.ts");
...
expectIncludes(healthRoute, "TRADING_ECONOMICS_API_KEY", "헬스체크 매크로 자동화 키", "src/app/api/health/route.ts");
