// Chart Radar 개인정보 처리 기준을 안내하는 정책 페이지입니다.
...
const sections = [
  {
    title: "1. 수집하는 정보",
    items: [
      "Google 로그인이 제공하는 이메일, 이름, 프로필 이미지 등 계정 식별 정보",
      "사용자가 직접 저장한 매매 복기, 관심 종목, 알림 조건, 사용 설정",
      "Pro 이용 확인을 위한 결제 식별값, 상품 ID, 구매 상태, 갱신 상태",
  ...
  },
  {
    ...
    items: [
      ...
      "계정 삭제를 요청하면 개인 식별 정보와 사용자가 생성한 데이터를 삭제하거나 익명화합니다.",
  ...
  },
  {
    ...
    items: [
      ...
      "앱 구독과 결제 확인은 앱 마켓 또는 결제 대행사의 시스템을 통해 처리합니다.",
      "AI 요약과 브리핑 기능에는 외부 AI 처리 기능이 사용될 수 있으며, 민감한 개인정보 입력은 권장하지 않습니다.",
      "외부 처리자에게는 서비스 제공에 필요한 범위의 정보만 전달되도록 관리합니다."
    ]
  },
  {
    title: "5. 사용자의 권리",
    items: [
      ...
      "개인정보 관련 문의는 support@chartradar.ai로 접수할 수 있습니다."
    ]
  }
];
