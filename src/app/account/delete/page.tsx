// Chart Radar 계정과 사용자 데이터 삭제 요청 방법을 안내하는 페이지입니다.
...
export const metadata: Metadata = {
  title: "계정·데이터 삭제 안내",
  description: "Chart Radar 계정과 사용자 데이터 삭제 요청 방법"
};
...
const retainedScope = [
  ...
  "개인을 식별할 수 없도록 익명화된 서비스 안정화 로그",
  "진행 중인 구독 상태 확인에 필요한 스토어 결제 식별 정보"
];
      ...
      <div className="mx-auto flex w-full max-w-4xl flex-col gap-5">
        ...
        <section className="rounded-lg border border-surface-line bg-surface-card p-5 shadow-glow">
          <div className="flex items-start gap-3">
            <div className="grid h-10 w-10 shrink-0 place-items-center rounded-lg border border-rose-300/25 bg-rose-300/10 text-rose-200">
            ...
            <div>
              ...
              <p className="mt-2 text-sm leading-6 text-slate-400 [word-break:keep-all]">
                Chart Radar 계정과 저장된 사용자 데이터 삭제를 원하시면 아래 절차에 따라 요청해 주세요.
              </p>
            </div>
          </div>

          <div className="mt-6 grid gap-4">
            <section className="rounded-lg border border-surface-line bg-surface-cardSoft p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mt-2 text-sm leading-7 text-slate-400 [word-break:keep-all]">
                    ...
                    “Chart Radar 계정 삭제 요청”이라고 보내 주세요. 본인 확인 후 영업일 기준 7일 이내에 삭제 처리 또는 추가 확인 요청을 안내합니다.
                  </p>
                </div>
              </div>
            </section>
        ...
        <section className="rounded-lg border border-signal-success/25 bg-signal-success/10 p-4 text-sm leading-6 text-slate-300">
          <div className="flex items-start gap-3">
            ...
            <p>
              유료 구독을 사용 중이라면 계정 삭제 전 Google Play 또는 결제 화면에서 구독 해지 상태를 먼저 확인해 주세요. 계정 삭제와
              스토어 구독 해지는 별개의 절차일 수 있습니다.
            </p>
          </div>
        </section>
